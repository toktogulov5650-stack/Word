...
public interface IAuthService
{
    ...
    Task<AuthResponseDto> SignInWithGoogleAsync(
        string idToken,
    ...
    Task<CurrentUserDto?> ChangeUserLanguageAsync(int userId, string languageCode, CancellationToken cancellationToken = default);
}
